from sqlalchemy import Column, String, Integer, Date, Numeric, Text, Boolean
...
class Galaxy(Base):
    ...
    def __init__(self, name, diameter, mass, age_in_millions_of_years, description, has_life, is_spherical):
        self.name = name
